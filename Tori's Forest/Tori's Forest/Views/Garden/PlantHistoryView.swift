...
struct PlantHistoryView: View {
    ...
    @State var objectNames: [String] = ["dandelion", "cactus", "maple", "cottontree"]

    var body: some View {
        let idx = objectNames.firstIndex(of: selectedViewName)
        let backgrounds: [String] = ["STR_Img_bg_1_spring", "STR_Img_bg_2_summer", "STR_Img_bg_3_autumn", "STR_Img_bg_4_winter"]
